...
// ─── LOCAL MODE ──────────────────────────────────────────────────────────────
// In Vite builds, use VITE_LOCAL_MODE env variable; fallback to true for dev
export const LOCAL_MODE = import.meta.env.VITE_LOCAL_MODE === 'false' ? false : true;
...
// ─── Sidebar shapes ───────────────────────────────────────────────────────────
export const SHAPES = {
  holiday: '★', payday: '●', birthday: '♥', meeting: '■',
  company: '▲', deadline: '◆', personal: '○', vacation: '🌴',
};
